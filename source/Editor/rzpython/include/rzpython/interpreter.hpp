...
protected:
    ...
    virtual Result ExecuteCommand(std::string_view command, const std::vector<std::string>& args) override;
    virtual std::vector<std::string> SuggestCommand(std::string_view command, std::string_view cmdline, size_t cursor_pos) override;
